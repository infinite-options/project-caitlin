package md507b0dc1ced67c56ddff26df8fb35cf18;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ProjectCaitlin.Helper.DbHelper, ProjectCaitlin", DbHelper.class, __md_methods);
	}
	...
	public DbHelper (android.content.Context p0, java.lang.String p1, android.database.sqlite.SQLiteDatabase.CursorFactory p2, int p3)
	{
		...
		if (getClass () == DbHelper.class)
			mono.android.TypeManager.Activate ("ProjectCaitlin.Helper.DbHelper, ProjectCaitlin", "Android.Content.Context, Mono.Android:System.String, mscorlib:Android.Database.Sqlite.SQLiteDatabase+ICursorFactory, Mono.Android:System.Int32, mscorlib", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
	...
	public DbHelper (android.content.Context p0, java.lang.String p1, android.database.sqlite.SQLiteDatabase.CursorFactory p2, int p3, android.database.DatabaseErrorHandler p4)
	{
		...
		if (getClass () == DbHelper.class)
			mono.android.TypeManager.Activate ("ProjectCaitlin.Helper.DbHelper, ProjectCaitlin", "Android.Content.Context, Mono.Android:System.String, mscorlib:Android.Database.Sqlite.SQLiteDatabase+ICursorFactory, Mono.Android:System.Int32, mscorlib:Android.Database.IDatabaseErrorHandler, Mono.Android", this, new java.lang.Object[] { p0, p1, p2, p3, p4 });
	}
	...
	public DbHelper (android.content.Context p0, java.lang.String p1, int p2, android.database.sqlite.SQLiteDatabase.OpenParams p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == DbHelper.class)
			mono.android.TypeManager.Activate ("ProjectCaitlin.Helper.DbHelper, ProjectCaitlin", "Android.Content.Context, Mono.Android:System.String, mscorlib:System.Int32, mscorlib:Android.Database.Sqlite.SQLiteDatabase+OpenParams, Mono.Android", this, new java.lang.Object[] { p0, p1, p2, p3 });
	}
