namespace Xamarin_GoogleAuth.Methods
{
    ...
    public partial class GetCalendarsMethod
    {
        public static GetCalendarsMethod FromJson(string json) => JsonConvert.DeserializeObject<GetCalendarsMethod>(json, Xamarin_GoogleAuth.Methods.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this GetCalendarsMethod self) => JsonConvert.SerializeObject(self, Xamarin_GoogleAuth.Methods.Converter.Settings);
    }
