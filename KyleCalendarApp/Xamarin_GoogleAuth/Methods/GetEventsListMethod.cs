namespace Xamarin_GoogleAuth.Methods
{
    ...
    public partial class GetEventsListMethod
    {
        public static GetEventsListMethod FromJson(string json) => JsonConvert.DeserializeObject<GetEventsListMethod>(json, Xamarin_GoogleAuth.Methods.Converter.Settings);
    }

    public static class Serialize1
    {
        public static string ToJson(this GetEventsListMethod self) => JsonConvert.SerializeObject(self, Xamarin_GoogleAuth.Methods.Converter.Settings);
    }
}
