namespace Xamarin_GoogleAuth.Methods
{
    ...
    public partial class GetFbActivitiesMethod
    {
        public static GetFbActivitiesMethod FromJson(string json) => JsonConvert.DeserializeObject<GetFbActivitiesMethod>(json, Xamarin_GoogleAuth.Methods.Converter.Settings);
    }
}
